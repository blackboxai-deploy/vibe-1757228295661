...
export default function EmploymentLawPage() {
  const area = practiceAreas.find(area => area.slug === 'employment-law')!
  ...
  return (
    <div className="min-h-screen py-12 bg-gray-50">
      <div className="container px-4 md:px-6 max-w-4xl mx-auto">
        ...
        <Card className="mb-8">
          <CardHeader><CardTitle className="text-2xl text-gray-900">Employment Legal Issues</CardTitle></CardHeader>
          <CardContent>
        ...
        <Card className="mb-8">
          <CardHeader><CardTitle className="text-2xl text-gray-900">Employment Law Process</CardTitle></CardHeader>
          <CardContent>
        ...
        <div className="text-center bg-blue-600 text-white p-8 rounded-lg">
          <h2 className="text-2xl font-bold mb-4">Workplace Rights Protection</h2>
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Every employee has rights that deserve protection. Our employment law attorneys fight for fair treatment and just compensation in workplace disputes.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-blue-50">
              <Link href="/contact">Employment Law Help</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-blue-600">
              <Link href="/legal-qa">Workplace Rights Info</Link>
            </Button>
          </div>
        </div>
      </div>
